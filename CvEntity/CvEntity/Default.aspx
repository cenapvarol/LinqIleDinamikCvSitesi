				...
				<div class="w3ls_main_grid_right_grid">	
					<div id="parentHorizontalTab">
						<ul class="resp-tabs-list hor_1">
							...
							<li><i class="fa fa-map-marker" aria-hidden="true"></i>Iletişim</li>
							<li><i class="fa fa-info" aria-hidden="true"></i>Yardım</li>
						</ul>
						<div class="resp-tabs-container hor_1">
							<div class="agileits_main_grid_right_grid">
								<div style="font-size:larger">
                                    <h3 style="font-weight: bold; font-size: large;margin-bottom:15px">Eğitim Hayatım</h3>
								</div>
								<p>
								...
								<div style="font-size:larger">
                                    <h3 style="font-weight: bold; font-size: large;margin-bottom:15px">Iş Deneyimim</h3>
								</div>
								<p>
