...
<body>
    <div class="sidenav text-center">
		<div class="side_top">
			...
			<p class="top_hdp mt-2">Bilgiayar Mühendisi</p>
        </div>
		<!-- header -->
        <header>
			<div class="nav-top">
				<nav class="mnu mx-auto">
                    ...
                    <input type="checkbox" id="drop">
						<ul class="menu">
							...
							<li class="mt-sm-3"><a href="#news" class="scroll">Deneyimleri</a></li>
...
<!-- contact -->
	...
	<h3 class="w3_head mb-4 text-left"> Iletişim</h3>
		...
		<div class="contact_grid_right mt-5 mx-auto text-left">
				<form action="#" method="post" runat="server">
					...
					<asp:Button ID="Button1" runat="server"  CssClass="btn btn-info" Text="Gönder" OnClick="Button1_Click" />
						<%--<button type="reset" class="btn">Yenile</button>--%>
					<asp:Button ID="Button2" runat="server"  CssClass="btn btn-info" Text="Vazgeç" />
